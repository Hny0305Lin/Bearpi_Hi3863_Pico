...
/* @ingroup socket */
#define getifaddrs(ifap)  lwip_getifaddrs(ifap)
#define freeifaddrs(ifa)  lwip_freeifaddrs(ifa)
#else /* LWIP_COMPAT_SOCKETS != 2 */
/* @ingroup socket */
#define lwip_getifaddrs(ifap)  getifaddrs(ifap)
#define lwip_freeifaddrs(ifa)  freeifaddrs(ifa)
...
* @return
* On success, lwip_getifaddrs() returns zero; on error, -1 is returned, and errno is set appropriately.
* @par Errors
*    @li The lwip_getifaddrs() function shall fail if:
...
/*
Func Name:  lwip_freeifaddrs
*/

/**
* @ingroup   ifaddrs_api
* @brief   The function lwip_freeifaddrs, provides the list of network interfaces in the ifaddrs* structure.
