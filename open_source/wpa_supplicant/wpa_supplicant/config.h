...
#define DEFAULT_BSS_MAX_COUNT 64
...
void wpa_get_user_config(p2p_user_persistent *user_config);

void wpa_set_user_config(p2p_user_persistent user_config);

void wpa_set_clear_user_config(void);

int wpa_network_clean(const char *ssid_name, size_t ssid_len);
#endif
#endif /* CONFIG_H */
