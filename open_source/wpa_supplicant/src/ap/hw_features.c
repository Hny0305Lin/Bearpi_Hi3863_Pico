...
#endif /* EXT_CODE_CROP || CONFIG_ACS */
...
int hostapd_select_hw_mode(struct hostapd_iface *iface)
{
	...
	if (g_ap_opt_set.hw_mode != WIFI_MODE_UNDEFINE) {
		if (g_ap_opt_set.hw_mode == WIFI_MODE_11B) {
			iface->conf->hw_mode = HOSTAPD_MODE_IEEE80211B;
			iface->conf->ieee80211n = 0;
		} else if (g_ap_opt_set.hw_mode == WIFI_MODE_11B_G) {
			iface->conf->hw_mode = HOSTAPD_MODE_IEEE80211G;
			iface->conf->ieee80211n = 0;
		} else if (g_ap_opt_set.hw_mode == WIFI_MODE_11B_G_N) {
			iface->conf->hw_mode = HOSTAPD_MODE_IEEE80211G;
	...
	if ((iface->conf->hw_mode == HOSTAPD_MODE_IEEE80211G ||
		...
		wpa_warning_log0(MSG_INFO, "Enable OFDM/HT/VHT/HE on channel 14");
#ifndef EXT_CODE_CROP
		iface->conf->hw_mode = HOSTAPD_MODE_IEEE80211B;
		iface->conf->ieee80211n = 0;
