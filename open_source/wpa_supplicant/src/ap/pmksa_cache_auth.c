...
#else
/* The value of WPA should be greater than the driver's default value of 32,
   and the default value of WPA is set to 36 */
static const int pmksa_cache_max_entries = 36;
#endif
