...
#ifdef CONFIG_MESH
		if ((hapd->conf->mesh & MESH_ENABLED) && (los_mesh_peer_connect_is_rejected())) {
...
#endif /* defined(LOS_CONFIG_HOSTAPD_MGMT) && defined(CONFIG_SAE) */
}
#endif /* LOS_CONFIG_HOSTAPD_MGMT */
