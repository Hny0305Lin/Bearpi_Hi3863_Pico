...
struct wpa_driver_ops {
   ...
   int (*get_drv_flags)(void *priv, u64 *drv_flag);
    ...
    /**
     * wifi_app_service_handle - Request the driver to traversal scan result lists and callback the wpa func
     * @priv: private driver interface data
     * @params: callback func to handle the wifi app service
     *
     * Returns: 0 on success, -1 on failure
     */
    int (*wifi_app_service_handle)(void *priv, void *params);
