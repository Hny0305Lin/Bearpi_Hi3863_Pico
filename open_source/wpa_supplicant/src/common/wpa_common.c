...
#else
#ifdef CONFIG_IEEE80211R
	return wpa_key_mgmt_sae(akmp) || akmp == WPA_KEY_MGMT_OWE || (akmp == WPA_KEY_MGMT_FT_IEEE8021X_SHA384);
#else
	return wpa_key_mgmt_sae(akmp) || akmp == WPA_KEY_MGMT_OWE;
#endif /* CONFIG_IEEE80211R */
#endif /* EXT_WPA_KEY_MGMT_CROP */
}
...
#if defined(CONFIG_SUITEB192) || defined (LOS_CONFIG_WPA_ENTERPRISE)
	if (RSN_SELECTOR_GET(s) == RSN_AUTH_KEY_MGMT_802_1X_SUITE_B_192)
		return WPA_KEY_MGMT_IEEE8021X_SUITE_B_192;
#endif /* CONFIG_SUITEB192 || LOS_CONFIG_WPA_ENTERPRISE */
#ifndef EXT_WPA_KEY_MGMT_CROP
...
int wpa_write_ciphers(char *start, char *end, int ciphers, const char *delim)
{
	...
	for (index = 0; index < sizeof(cipherTypes) / sizeof(struct cipher_Types); index++) {
		if ((unsigned int)ciphers & (unsigned int)cipherTypes[index].cipher_type) {
