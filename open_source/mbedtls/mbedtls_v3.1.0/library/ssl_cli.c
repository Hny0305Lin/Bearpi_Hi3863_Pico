...
#if defined(VENDOR_ONT_CUSTOMIZE_SSL_CLIENT_HELLO_C) || \
    defined(VENDOR_ONT_TLS_CERT_FAILED_NOTICE_C) || \
    defined(VENDOR_ONT_SSL_WRITE_HOSTNAME_C)
...
#if defined(VENDOR_ONT_SSL_WRITE_HOSTNAME_C)
...
#else
#if defined(VENDOR_ONT_CUSTOMIZE_SSL_CLIENT_HELLO_C)
    if ( ssl_deprecated_kexsize_support() == 0 && ssl->handshake->ecdh_ctx.grp.nbits < 223 )
    {
