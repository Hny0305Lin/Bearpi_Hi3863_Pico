...
/*****************************************************************************
 * @brief 定制特性：支持证书、CRL有效期的有条件忽略。具体的条件由产品自己实现。
 * 
******************************************************************************/
#if defined(VENDOR_CUSTOMISE_CHECK_CERT_DATE_C)

/*****************************************************************************
 * @brief 定制特性，有条件忽略证书有效期，产品注册回调函数校验。
 * 
******************************************************************************/
hw_mbedtls_cert_date_checker g_mbedtls_customize_cert_date_checker = NULL;

/*****************************************************************************
 * @brief 定制特性，有条件忽略CRL有效期，产品注册回调函数校验。
 * 
******************************************************************************/
...
#if defined(VENDOR_ONT_CHECK_CERT_CN_NAME_C)
/*****************************************************************************
 * @brief 定制，ONT产品特殊处理，用于校验证书的CN名
