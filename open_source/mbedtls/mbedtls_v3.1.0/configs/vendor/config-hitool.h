/**
 * \file config-hitool.h
 *
 * \brief SecureTool mbedtls库的配置文件，基于3.1.0版本的include\mbedtls\mbedtls_config.h配置文件。
 *
 *  产品在使用时，在编译前，将此文件强制覆盖默认的配置文件即可，使用方式如下：
 *  cp -f ./configs/vendor/config-hitool.h ./include/mbedtls/mbedtls_config.h
 */
