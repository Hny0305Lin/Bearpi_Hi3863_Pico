...
#ifdef CONFIG_VFS_POLL_WITHOUT_SETUP
#include <poll.h>
#endif
#include <sys/types.h>
#include <sys/stat.h>
...
#include <stdbool.h>
#include <time.h>
#ifdef CONFIG_VFS_EXTEND_HEADER_FILE
#include <vfs_extend.h>
#endif
...
#ifndef CONFIG_VFS_UNBIND_WITHOUT_FLAGS
...
struct stat;
struct statfs;
#ifndef CONFIG_VFS_POLL_DISABLE
struct pollfd;
#endif
struct fs_dirent_s;
struct mtd_dev_s;
...
#ifdef CONFIG_VFS_OPERATION_EXTEND
...
struct block_operations
{
  ...
  ssize_t (*write)(FAR struct inode *inode, FAR const unsigned char *buffer,
            blkcnt_t start_sector, unsigned int nsectors);
#endif
#ifdef CONFIG_VFS_WRITEV_SUPPORT
...
struct mountpt_operations
{
...
#ifdef CONFIG_VFS_BIND_WITH_PATH
  ...
  int     (*bind)(FAR struct inode *blkdriver, FAR const void *data,
            FAR void **handle);
#endif
#ifdef CONFIG_VFS_UNBIND_WITHOUT_FLAGS
...
#ifdef CONFIG_VFS_MOUNT_STATUS_ENABLE
  unsigned long     mountflags; /* Flags for mount */
  int32_t           e_status;   /* Status for mount */
#endif
...
#ifdef CONFIG_VFS_FULLPATH_ACQUIRE
...
#ifdef CONFIG_VFS_FILELIST_EXTERN
 ...
 *
 * Description:
 *   Visit each mountpoint in the pseudo-file system
 *
 * Input Parameters:
 *   handler - foreach_mountpoint_t operation function when find a mount point
 *   arg     - The private data
 *
 * Returned Value:
 ...
 *
 *   EINVAL  - pathname or ppinode is NULL.
...
#ifndef CONFIG_DISABLE_MOUNTPOINT
#ifdef CONFIG_VFS_UNBIND_WITHOUT_FLAGS
int nx_umount2(FAR const char *target);
#else
 ...
 *
 ****************************************************************************/
#ifdef CONFIG_VFS_FILE_FORCE_RELEASE
int file_close(FAR struct file *filep, bool force);
#else
 ...
 ****************************************************************************/
#ifndef CONFIG_VFS_POLL_DISABLE
#ifndef CONFIG_VFS_POLL_WITHOUT_SETUP
