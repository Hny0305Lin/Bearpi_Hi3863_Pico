...
#ifdef CONFIG_VFS_DISABLE_INCLUDE_NUTTX_FS_H
#include "limits.h"
#include "fs/fs.h"
#include "fs/file.h"
#else
...
#ifdef CONFIG_VFS_SUPPORT_ERROR_RETURN
#ifndef ERROR
#define ERROR -1
#endif
#endif
...
int files_allocate(FAR struct inode *inode, int oflags, off_t pos,
                   FAR void *priv, int minfd, FAR struct file *filep);
#else
int files_allocate(FAR struct inode *inode, int oflags, off_t pos,
